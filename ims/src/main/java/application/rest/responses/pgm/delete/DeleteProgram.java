...
@Schema(description = "POJO from a Delete PGM command that represents output for one program")
public class DeleteProgram {
	...
	String cctxt;
	@Schema(description = "Error text that provides diagnostic information. Error text can be returned for a non-zero completion code and further explains the completion code.")
	String errt;
