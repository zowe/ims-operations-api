...
public class TestUpdateTran {
	...
	public void testUpdateTranStopSchd() {
		...
		Response responses = RequestUtils.putRequest(queryParams, "/transaction/", client);
		...
		Response responses2 = RequestUtils.getRequest(queryParams2, "/transaction/", client);
		...
		Response responses3 = RequestUtils.putRequest(queryParams3, "/transaction/", client);
		...
		Response responses4 = RequestUtils.getRequest(queryParams4, "/transaction/", client);
